...
create table public.role_has_menus (
  ...
  menus_id integer null,
  constraint role_has_menus_pkey primary key (id),
  constraint role_has_menus_menus_id_fkey foreign KEY (menus_id) references menus (id),
  constraint role_has_menus_role_id_fkey foreign KEY (role_id) references roles (id)
