...
export default function TabPenugasan() {
    return (
        <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-3 sm:p-4">
            {/* Search + Filter */}
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
                ...
                <div className="flex border border-gray-200 rounded-lg overflow-hidden divide-x divide-gray-200 shadow-sm">
                    <button className="px-3 sm:px-4 py-2 bg-blue-50 text-blue-600 font-medium text-xs sm:text-sm hover:bg-blue-100 transition-colors">
                        Pending
                    </button>
                    <button className="px-3 sm:px-4 py-2 text-xs sm:text-sm text-gray-600 bg-white hover:bg-gray-50 transition-colors">
                        Selesai
                    </button>
                    <button className="px-3 sm:px-4 py-2 text-xs sm:text-sm text-gray-600 bg-white hover:bg-gray-50 transition-colors">
                        Semua
                ...
                <table className="w-full text-sm text-left min-w-[600px]">
                    <thead className="bg-gray-50 text-gray-600 text-xs uppercase font-medium">
                        <tr className="border-b border-gray-200">
                            <th className="px-3 sm:px-4 py-3">Mahasiswa</th>
                            <th className="px-3 sm:px-4 py-3">Pekerjaan</th>
                            <th className="px-3 sm:px-4 py-3 text-center">Jam</th>
                            <th className="px-3 sm:px-4 py-3 text-center">Update</th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {[1, 2, 3, 4].map((_, i) => (
                            <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td className="px-3 sm:px-4 py-3 text-gray-600">Benarkan PC</td>
                                <td className="px-3 sm:px-4 py-3 text-center text-gray-600">8j</td>
                                <td className="px-3 sm:px-4 py-3 text-center text-gray-600">19 April 2026</td>
