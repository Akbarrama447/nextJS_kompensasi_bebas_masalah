              ...
              {dataTugas.map((t: any) => (
                <tr key={t.id} className="border-b border-slate-50 hover:bg-slate-50/30 transition-colors">
                  ...
                  <td className="px-6 py-6 text-center">
                    <span className={`px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-tighter ${t.status_tugas_id === 2 ? 'bg-blue-50 text-[#2e5299]' :
                  ...
                  <td className="px-8 py-6 text-right">
                    {t.status_tugas_id <= 2 && (
                      <button
                        ...
                        className={`px-6 py-2 rounded-xl font-bold text-[10px] uppercase tracking-wider transition-all active:scale-95 ${t.status_tugas_id === 1 ? 'bg-[#2e5299] text-white shadow-md' : 'bg-white border border-slate-200 text-slate-800 hover:bg-slate-50'
                          }`}
                      >
